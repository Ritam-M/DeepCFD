...
Forked from the main authors. My additions: Double UNet, Multi-ResUNet, Changed Architectures in AutoEncoders. Future additions: Diverse dataset of different flows, Transformers, CNN+Attention based structures, and GAN Implementations. 
